...
// TEST(road_slope_detection_ros_tool, testRoadRebuild){
//    your test goes here
// }


// This test just ensures that the node can be launched sucessfully. You can remove this if you have a better test.
TEST(road_slope_detection_ros_tool, testRoadRebuildNodeInitialization) {
...
int main(int argc, char** argv) {
    ...
    ros::init(argc, argv, "road_rebuild_test");
