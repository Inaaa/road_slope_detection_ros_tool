...
// TEST(road_slope_detection_ros_tool, testRingKeeper){
//    your test goes here
// }


// This test just ensures that the node can be launched sucessfully. You can remove this if you have a better test.
TEST(road_slope_detection_ros_tool, testRingKeeperNodeInitialization) {
...
int main(int argc, char** argv) {
    ...
    ros::init(argc, argv, "ring_keeper_test");
