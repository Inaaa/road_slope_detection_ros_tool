 ...
 * Initialization
 */
TfTramsform::TfTramsform(const ros::NodeHandle& nhPrivate) : interface_{nhPrivate}, reconfigureServer_{nhPrivate} {
     ...
     *
     * New subscribers can be created with "add_subscriber" in "cfg/TfTramsform.if file.
     * Don't forget to register your callbacks here!
     */
    reconfigureServer_.setCallback(boost::bind(&TfTramsform::reconfigureCallback, this, _1, _2));
    interface_.dummy_subscriber->registerCallback(&TfTramsform::messageCallback, this);
 ...
 */
void TfTramsform::messageCallback(const Msg::ConstPtr& msg) {
 ...
 */
void TfTramsform::reconfigureCallback(const Interface::Config& config, uint32_t /*level*/) {
